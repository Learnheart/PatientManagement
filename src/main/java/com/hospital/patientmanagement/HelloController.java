...
//                    prepare =
                    String updatePass = "UPDATE user SET password=?, date=? WHERE username=?";
                    prepare = connect.prepareStatement(updatePass);
                    prepare.setString(1, fg_password.getText());
                    prepare.setString(2, date);
                    prepare.setString(3, fg_username.getText());
//                    result = prepare.executeQuery();
